...
The root schema is \field{jetbns.npc-model-export.v2}. Versions predating the
audit must be regenerated: they can severely underresolve the measured outflow.
...
must be below 5 percent. An independent 1536-point opacity integral must satisfy
...
The jet remains conical and uncollimated. Breakout follows the legacy grey
